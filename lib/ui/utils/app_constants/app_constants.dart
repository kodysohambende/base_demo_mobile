...
class AppConstants {
  ...
  // static const String appEnv = String.fromEnvironment('APP_ENV', defaultValue: Env.kodyinfotech);
  static String formattedDate(int timestamp){
    DateTime date = DateTime.fromMillisecondsSinceEpoch(timestamp);
    return DateFormat("ddMMM, yyyy").format(date);
  }

  ///----------------------- service url-------------------///
  //  static const String developmentBaseUrl = 'http://192.168.1.231:7901/odigo/v3';
  static const String developmentBaseUrl = 'http://192.168.1.157:7901/odigo/v3';
  static const String kodyinfotechBaseUrl = 'https://service.odigo-v3.kodyinfotech.com/odigo/v3';


  ///---------payment url---------------///
  static const String paymentDevBaseUrl = 'https://192.168.1.231:7901/odigo/v3';
  static const String paymentKodyInfoTechUrl = 'https://client.odigo-v3.kodyinfotech.com';
  static const String trimmerUrl = 'http://49.13.228.207:6010/';

  // static String paymentBaseUrl() =>  appEnv == Env.kodyinfotech ? paymentKodyInfoTechUrl : paymentDevBaseUrl;

  static AppConstants constant = AppConstants._();

  static const appName = 'Base Demo';
  ...
  static String userBoxName = 'user_model';
  static String zoomBoxName = 'odigo_assistant_admin_zoom';
