...
import 'package:base_demo_ob/ui/home/home.dart';
import 'package:base_demo_ob/ui/splash/splash.dart';
...
import 'package:base_demo_ob/ui/error/error_404.dart';
...
class MainRouterDelegate extends RouterDelegate<NavigationStack> with ChangeNotifier, PopNavigatorRouterDelegateMixin {
  ...
  List<Page> _pages(WidgetRef ref) => stack.items
      ...
      /// Error
      error: (key, errorType) => NoAnimationPage(
        child: ErrorWeb(errorType: errorType),
      ),
